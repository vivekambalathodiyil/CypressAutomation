...
it.only('Users page CSV flie download', function(){
// Visit home page and check filter options and compliance %
    cy.visit('/local/wdtcompliance/reporting_workplace/userlist.php')
    ...
    cy.window().document().then(function (doc) {
        ...
        cy.contains('Download').click()
        cy.ve
        cy.readFile('cypress/downloads/userlist.csv').should('exist')
        })
...
it('Certifications page XLSX file download',function(){
