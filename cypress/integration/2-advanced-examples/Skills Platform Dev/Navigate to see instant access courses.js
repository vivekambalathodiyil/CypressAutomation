...
describe('Search and buy instant access course', function() {
 ...
 it('Search a course', function() {
    ...
    cy.visit('https://dev.skillsplatform.org/search?keywords=&page=')


  cy.contains('.courselist', 'Instant Access').find(':nth-child(4) > .wrapper > .inner > .details > .actions.hide-mobile > .red').click()
  cy.get('#submitform').click()
  cy.visit('https://dev.skillsplatform.org').get('#header_search_form > .linkedinputs > .button > .fa').click()
  //Second page
  cy.visit('https://dev.skillsplatform.org/search?keywords=&page=2')
...
cy.get('#fullnav > :nth-child(1)').find('care').click()
     ...
     //    cy.visit('https://dev.skillsplatform.org/search?keywords=&page=3') 
