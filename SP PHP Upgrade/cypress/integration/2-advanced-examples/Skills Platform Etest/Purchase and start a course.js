...
describe  ('Information Governance',function()
{
    it('Purchase IG course and open',function() 
    {
        ...
        cy.visit('https://etest.skillsplatform.org/courses/2314-information-governance');
        ...
        cy.get('#input_email')
//Input user form
        cy.visit('https://etest.skillsplatform.org/checkout');
...
//Input Card detils
    ...
    cy.visit('https://etest.skillsplatform.org/dashboard/profile');
   
   cy.xpath('/html/body/div[2]/div/div[1]/div/ul/li[3]/a').click()
...
cy.go('back')
        ...
        function Generatenewuser () {
            ...
            cy.get(':nth-child(9) > .fieldinput > select').select('United Kingdom');
            cy.get(':nth-child(12) > .fieldinput > .checkbox > span').click();
        }
